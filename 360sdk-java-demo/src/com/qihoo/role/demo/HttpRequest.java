...
public class HttpRequest {
	...
	private static String json = "";
    public static void main(String[] args) {
    	String url = "http://role.gamebox.360.cn/7/role/rolesave";
    	String role = URLEncoder.encode(json);
